...
int misc_init_r(void)
{
	unsigned int pins;
#if defined(STG100R3)
	/* GPIO_B[1]: green SYS LED */
	*(volatile u32*)GPIO_2_SET = (1 << 1);
	*(volatile u32*)GPIO_2_SET_OE = (1 << 1);
#elif defined(STG211)
	/* GPIO_A[26]: green SYS LED */
	*(volatile u32*)GPIO_1_SET = (1 << 26);
	*(volatile u32*)GPIO_1_SET_OE = (1 << 26);
#endif
	return 0;
}
