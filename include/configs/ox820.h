...
#define CONFIG_PAGE_REPLICATION 1

// number of blocks to duplicate to allow for errors in NAND flash, 2 for SLC more for MLC
#define CONFIG_BLOCK_REPLICATION 1

#define CONFIG_FLASH_KERNEL_SPACE       10 * 1024 * 1024 // 10MB; In fact, 2.5MB is for possible NAND bad blocks.
/*****
...
#if defined(STG100R1) || defined(STG100R3)
#define CONFIG_EXTRA_ENV_SETTINGS \
	"load_nand=nboot 61000000 0 440000\0" \
	"boot=bootm 61000000\0" \
	"boot_nand=run load_nand boot\0" \
	"MODEL_ID=A403\0" \
	"PRODUCT_NAME=STG-100\0" \
	"VENDOR_NAME=MitraStar Technology Corp.\0"
#elif defined(STG211)
#define CONFIG_EXTRA_ENV_SETTINGS \
	"load_nand=nboot 61000000 0 440000\0" \
	"boot=bootm 61000000\0" \
	"boot_nand=run load_nand boot\0" \
	"MODEL_ID=A803\0" \
	"PRODUCT_NAME=STG-211\0" \
	"VENDOR_NAME=MitraStar Technology Corp.\0"
#elif defined(STG212)
	/* STG100R1, STG100R3, STG211, STG212 */
#define CONFIG_EXTRA_ENV_SETTINGS \
	"load_nand=nboot 61000000 0 440000\0" \
	"boot=bootm 61000000\0" \
	"boot_nand=run load_nand boot\0" \
	"MODEL_ID=AB03\0" \
	"PRODUCT_NAME=STG-212\0" \
	"VENDOR_NAME=MitraStar Technology Corp.\0"
#elif defined(STG222)
#define CONFIG_EXTRA_ENV_SETTINGS \
	"load_nand=nboot 61000000 0 440000\0" \
...
#define CFG_ENV_NAND_REDUNDANT_REGION   1
#else // ENV_ON_NAND
